...
echo "test,rad,sortdeg1_wcol,sortdeg1_LS,td_wcol,td_LS,fill-in_wcol,fill-in_LS,berlin.sna_wcol,berlin.sna_LS,WReachR_wcol,WReachR_LS,SReachR_wcol,SReachR_LS,felixR_wcol,felixR_LS" > ../$1_LS_rep.csv
...
for rad in {2..5}; do
  for input in *.txtg; do
    ...
    wreach="bywreach"$rad
    sreach="bysreach"$rad
    progs="sortdeg1 td fill-in berlin.sna "$wreach" "$sreach" "$felix
